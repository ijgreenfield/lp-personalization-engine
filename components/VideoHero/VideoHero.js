    ...
    return (
        <Box>
            <Box pos="relative" h="100%" pt={["104px", null, null, "0px"]} pb={["48px", null, null, "0"]}>
                <Flex pos={["relative",null, null, null, "absolute"]} top="0" right="0" left="0" bottom="0" zIndex={5} m={["0","auto"]} px="20px" h="max-content" w={["100%","80%"]} justify="space-between" alignItems="center" flexDirection={["column", null, null, "row"]} id="booking-form" maxH={[null, null, "70%"]} maxW="1280px">
                    ...
                    <Stack maxW="460px" w={["100%", null, "50%"]} h="auto" minW={[null,"460px"]} bg="#fff" p={["20px","30px"]} borderRadius="8px" alignItems="center" textAlign="center" display='block' spacing="16px" my={["16px", null, null, "80px"]}>
                        <Box>
                ...
                <Box pos="absolute" top="0" left="0" zIndex={1} w="100%" h="100%" display={["block", null, null, null, "none"]}>
                    <Image 
                ...
                <Box zIndex={1} h="100%" display={["none", null, null, null, "block"]}>
                    <Box minH="100%">
