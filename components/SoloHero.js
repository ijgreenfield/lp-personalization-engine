    ...
    return (
        <Box bg='linear-gradient(180deg, #FEF2E1 0%, #FFEEDB 100%);'>
            <Container maxW='1280px' py="96px">
                <Box pos="relative">
                    <Stack maxW="50%" marginBottom="40px" spacing="16px">
                        <Heading fontSize="56px" fontWeight={500}>Welcome to your Heyday, Plymouth Meeting</Heading>
                    ...
                    <Box>
                        <Text textTransform="uppercase">As Seen In</Text>
            ...
            <Box pos="absolute" bottom="0" right="0" w="50%">
                <Image 
